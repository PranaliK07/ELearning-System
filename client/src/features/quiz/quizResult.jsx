        ...
        <Box sx={{ py: 2 }}>
          ...
          >
            ...
            <Box sx={{ display: 'flex', gap: 2, justifyContent: 'center', flexWrap: 'wrap' }}>
              ...
              <Button variant={passed ? 'contained' : 'outlined'} onClick={handleBackToQuiz} size="medium" startIcon={<QuizIcon />} sx={{ px: 4, borderRadius: 2, bgcolor: passed ? '#D18AC4' : 'transparent', flex: { xs: '1 1 auto', sm: '0 0 auto' } }}>
                Back to Quiz
              </Button>
            </Box>
          </Paper>
