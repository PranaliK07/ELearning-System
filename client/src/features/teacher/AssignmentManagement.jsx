...
import { Add, Assignment, Delete, Edit, Visibility, MenuBook, Event, Description, School, Attachment } from '@mui/icons-material';
          ...
          <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2, pt: 2 }}>
            ...
            <Grid container spacing={2}>
              ...
              <Grid size={{ xs: 12, sm: 6 }}>
                {fieldRow(
                  ...
                  <TextField select label="Class" fullWidth value={formData.gradeId} onChange={(e) => { setFormData({ ...formData, gradeId: e.target.value }); setErrors((prev) => ({ ...prev, gradeId: '' })); }} error={!!errors.gradeId} helperText={errors.gradeId}>
            ...
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
              <Button
                ...
                startIcon={<Attachment fontSize="small" />}
              >
